...
import type { CustomerConversationState, ForliState } from '../forli-onboarding';
...
export interface ConversationDocument {
    ...
    summary?: string;
    callbackTime?: string;
    customerState?: string;   // JSON-serialised CustomerConversationState
    onboardingState?: string; // JSON-serialised ForliState
...
/** Deterministic conversation ID: "{businessId}_{callerPhoneWithoutPlus}" */
