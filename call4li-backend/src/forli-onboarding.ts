/**
 * Forli onboarding engine — rule-based state machine for WhatsApp business registration.
 * Also contains shared types used across the backend.
 */
...
/** Customer conversation state — persisted as JSON in Firestore. */
export type CustomerConversationPhase = 'awaiting' | 'collecting' | 'scheduled' | 'closed';
...
export function buildOpeningMessage(businessName: string, lang: Lang = 'he', customButtons?: string[]): string {
